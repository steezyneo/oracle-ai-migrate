-- The following migration is for PostgreSQL/Supabase only. It is commented out to avoid errors in SQL Server tools/linters.
-- Uncomment if using with PostgreSQL/Supabase.
